...
public class KafkaProducerDemo {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        ProducerRecord<String, String> message = new ProducerRecord<>("cutie", "key", "cutie111");
    ...
    private static Producer<String, String> createProducer() {
        ...
        properties.put("bootstrap.servers", "127.0.0.1:9092,127.0.0.1:9093,127.0.0.1:9094"); // 设置 Broker 的地址
