...
import io.kimmking.rpcfx.netty.KryoTransferClient;
...
public final class Rpcfx {
    ...
    public static <T, filters> T createFromRegistry(final Class<T> serviceClass, final String zkUrl, Router router, LoadBalancer loadBalance, Filter filter) throws InstantiationException, IllegalAccessException {
...
//                new RpcfxInvocationHandler(serviceClass, url, filters));
        ...
        Class<?> dynamicType = unloadedType.load(Rpcfx.class.getClassLoader()).getLoaded();
...
//            msg.setServiceClass(req.getServiceClass());
//            msg.setParams(req.getParams());
//            KryoTransferClient kryoTransferClient = new KryoTransferClient("127.0.0.1", 9001, msg);
//            kryoTransferClient.send();
//
//            String respJson = "";
